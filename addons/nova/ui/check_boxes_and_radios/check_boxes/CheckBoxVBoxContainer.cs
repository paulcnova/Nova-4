...
/// <summary>A vertical box container that acts like a check box container.</summary>
[GlobalClass] public partial class CheckBoxVBoxContainer : VBoxContainer, ICheckBoxContainer
{
	#region Properties
	...
	protected virtual void DisableAllUnselected()
	{
		foreach(Node child in this.GetChildren())
		{
			if(child is Button button)
